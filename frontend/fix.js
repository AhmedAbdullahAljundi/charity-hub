...
const targetStr = `  <SelectItem value="-2.0">{t("wizard.persons.prisonSuspicionOptions.high")}</SelectItem>
          } else {
...
if(content.includes(targetStr)) {
    ...
    console.log("Successfully fixed PersonsStep.tsx");
} else {
    console.log("Target string not found in PersonsStep.tsx");
}
